...
public class StatLayers {
    ...
    public static class Offensive {
        public static StatLayer DAMAGE_CONVERSION = new StatLayer("damage_conversion", "Damage Conversion", StatLayer.LayerAction.ADD, -Integer.MAX_VALUE, -Integer.MAX_VALUE, Integer.MAX_VALUE);
    ...
    public static class Defensive {
        ...
        public static StatLayer FLAT_DAMAGE_REDUCTION = new StatLayer("flat_damage_reduction", "Flat Damage Reduction", StatLayer.LayerAction.ADD, 200, -Integer.MAX_VALUE, Integer.MAX_VALUE);
