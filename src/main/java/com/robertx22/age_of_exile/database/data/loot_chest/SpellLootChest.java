...
public class SpellLootChest extends LootChest {

    @Override
    public ItemStack generateOne(LootChestData data) {
        SkillGemBlueprint b = new SkillGemBlueprint(LootInfo.ofLevel(data.lvl), SkillGemData.SkillGemType.SKILL);
    ...
    @Override
    public int Weight() {
        return (int) (ServerContainer.get().SKILL_GEM_DROPRATE.get() * 100);
    }
