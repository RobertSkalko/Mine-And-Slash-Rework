...
public class MobRarities implements ExileRegistryInit {
    ...
    public void registerAll() {
        ...
        MobRarity.of(IRarity.UNCOMMON, "Uncommon", 1000, 0, 0.25F, 1, ChatFormatting.GREEN);
        MobRarity.of(IRarity.RARE_ID, "Rare", 500, 3, 1, 1, ChatFormatting.AQUA);
        MobRarity.of(IRarity.EPIC_ID, "Epic", 250, 20, 2, 2, ChatFormatting.LIGHT_PURPLE);
        MobRarity.of(IRarity.LEGENDARY_ID, "Legendary", 50, 40, 4, 3, ChatFormatting.GOLD);
