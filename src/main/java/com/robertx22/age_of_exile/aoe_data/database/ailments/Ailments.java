...
public class Ailments {
    ...
    public static Ailment POISON = new Ailment("poison", Elements.Chaos, true, false, 0.75F, 0, 200, x -> "Deals " + x.getPercentDamage() + "% of the damage as " + x.element.getIconNameDmg() + " for " + x.getDurationSeconds() + "s.");
