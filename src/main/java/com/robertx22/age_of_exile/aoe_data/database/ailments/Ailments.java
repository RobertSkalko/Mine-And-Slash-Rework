...
public class Ailments {
    ...
    public static Ailment FREEZE = new Ailment("freeze", Elements.Cold, false, true, 1, 0.1F, 0, x -> "Slows Enemy and Accumulates " + x.getPercentDamage() + "% of the damage which can be activated to deal bonus " + x.element.getIconNameDmg());

    public static Ailment ELECTRIFY = new Ailment("electrify", Elements.Lightning, false, true, 1.25F, 0.1F, 0, x -> "Accumulates " + x.getPercentDamage() + "% of the damage which can be activated to deal bonus " + x.element.getIconNameDmg());
