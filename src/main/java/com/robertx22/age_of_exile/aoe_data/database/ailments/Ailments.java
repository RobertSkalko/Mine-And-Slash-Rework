...
public class Ailments {
    ...
    public static Ailment POISON = new Ailment("poison", Elements.Shadow, true, false, 1, 0, 200, x -> "Deals " + x.getPercentDamage() + "% of the damage as " + x.element.getIconNameDmg() + " for " + x.getDurationSeconds() + "s.");
    ...
    public static Ailment ELECTRIFY = new Ailment("electrify", Elements.Nature, false, true, 1.25F, 0.1F, 0, x -> "Accumulates " + x.getPercentDamage() + "% of the damage which can be activated with SHOCK to deal bonus " + x.element.getIconNameDmg());
