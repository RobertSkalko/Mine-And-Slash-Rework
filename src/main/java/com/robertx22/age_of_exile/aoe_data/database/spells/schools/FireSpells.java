...
public class FireSpells implements ExileRegistryInit {
    ...
    public void registerAll() {
        ...
        SpellBuilder.of(MAGMA_FLOWER, PlayStyle.INT, SpellConfiguration.Builder.instant(15, 20 * 30)
                ...
                .onTick("block", PartBuilder.damageInAoe(SpellCalcs.MAGMA_FLOWER, Elements.Fire, 3D).tickRequirement(20D).disableKnockback())
        ...
        SpellBuilder.of(FIRE_NOVA_ID, PlayStyle.STR, SpellConfiguration.Builder.instant(20, 20 * 25), "Fire Nova",
                ...
                .onCast(PartBuilder.nova(ParticleTypes.FLAME, 200D, 5D, 0.05D).hideInFX())
                .onCast(PartBuilder.nova(ParticleTypes.FLAME, 100D, 3.5D, 0.05D).hideInFX())
                .onCast(PartBuilder.nova(ParticleTypes.FLAME, 100D, 1.5D, 0.05D).hideInFX())
                .onCast(PartBuilder.nova(ParticleTypes.SMOKE, 200D, 1D, 0.05D).hideInFX())
