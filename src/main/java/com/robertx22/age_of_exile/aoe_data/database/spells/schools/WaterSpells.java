...
public class WaterSpells implements ExileRegistryInit {
    ...
    public void registerAll() {
        ...
        SpellBuilder.of(HEART_OF_ICE, PlayStyle.INT, SpellConfiguration.Builder.instant(20, 10)
                ...
                .onCast(PartBuilder.justAction(SpellAction.SUMMON_FX_HOLDER.createFXHolder(20D * 5, "heart_of_ice")
                        .put(MapField.HEIGHT, 0.5D)
                ))
                .onCast(PartBuilder.groundParticles(ParticleTypes.SPLASH, 50D, 5D, 0.2D).hideInFX())
                .onCast(PartBuilder.groundParticles(ParticleTypes.DRIPPING_WATER, 50D, 5D, 0.2D).hideInFX())
                .onCast(PartBuilder.groundParticles(ParticleTypes.HEART, 50D, 5D, 0.2D).hideInFX())
