...
public class Perks implements ExileRegistryInit {
    ...
    public void registerAll() {
        ...
        PerkBuilder.stat(new OptScaleExactStat(2, OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Physical), ModType.FLAT));
        PerkBuilder.bigStat(new OptScaleExactStat(10, OffenseStats.ELEMENTAL_DAMAGE.get(Elements.Physical), ModType.FLAT));
