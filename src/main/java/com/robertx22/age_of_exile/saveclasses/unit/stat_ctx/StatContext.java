...
public abstract class StatContext {
    ...
    public enum StatCtxType {
        GEAR, BASE_STAT, PROPHECY_CURSE, NEWBIE_RESISTS, JEWEL, VANILLA_STAT_COMPAT, BONUS_XP_PER_CHARACTER, COMMAND_EXACT_STATS, STAT_POINTS, TALENT, POTION_EFFECT, AURA, MISC, MOB_AFFIX, FOOD_BUFF
    }
}
