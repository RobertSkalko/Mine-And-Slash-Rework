        ...
        try {
            ...
            if (entity instanceof Player) {
                ...
                if (entity.tickCount % 100 == 0) {
                    ...
                    int max = Math.round(data.getResources().getMax(entity, ResourceType.blood));
                    p.resetStat(Stats.CUSTOM.get(PlayerStats.TOTAL_BLOOD));
                    p.awardStat(Stats.CUSTOM.get(PlayerStats.TOTAL_BLOOD), max);

                    max = Math.round(data.getResources().getMax(entity, ResourceType.mana));
                    p.resetStat(Stats.CUSTOM.get(PlayerStats.TOTAL_MANA));
                    p.awardStat(Stats.CUSTOM.get(PlayerStats.TOTAL_MANA), max);

                    max = Math.round(data.getResources().getMax(entity, ResourceType.energy));
                    p.resetStat(Stats.CUSTOM.get(PlayerStats.TOTAL_ENERGY));
                    p.awardStat(Stats.CUSTOM.get(PlayerStats.TOTAL_ENERGY), max);

                    max = Math.round(data.getResources().getMax(entity, ResourceType.magic_shield));
                    p.resetStat(Stats.CUSTOM.get(PlayerStats.TOTAL_MAGIC_SHIELD));
                    p.awardStat(Stats.CUSTOM.get(PlayerStats.TOTAL_MAGIC_SHIELD), max);

                    max = Math.round(data.getResources().getMax(entity, ResourceType.health));
                    p.resetStat(Stats.CUSTOM.get(PlayerStats.TOTAL_HEALTH));
                    p.awardStat(Stats.CUSTOM.get(PlayerStats.TOTAL_HEALTH), max);
                }
            }
