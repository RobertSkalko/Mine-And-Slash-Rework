...
public class ChaosStats implements ExileRegistryInit {
    ...
    public void registerAll() {
        ...
        new ChaosStat("normal_high", "Ascended", 500, 1, Affix.Type.chaos_stat, 1, IRarity.NORMAL_GEAR_RARITIES).addToSerializables();
        ...
        new ChaosStat("unique_high", "Ascended", 250, 1, Affix.Type.chaos_stat, 1, List.of(IRarity.UNIQUE_ID, IRarity.RUNEWORD_ID)).addToSerializables();
