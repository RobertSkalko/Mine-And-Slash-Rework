...
public class MobRarities implements ExileRegistryInit {
    ...
    public void registerAll() {
        ...
        MobRarity.of(IRarity.EPIC_ID, "Epic", 250, 20, 2, 2, ChatFormatting.LIGHT_PURPLE, false).setElite();
        MobRarity.of(IRarity.LEGENDARY_ID, "Legendary", 50, 40, 4, 3, ChatFormatting.GOLD, false).setElite();
        MobRarity.of(IRarity.MYTHIC_ID, "Mythic", 25, 50, 8, 3, ChatFormatting.DARK_PURPLE, false);
        MobRarity.of(IRarity.UBER, "Uber", 0, 1, 15, 0, ChatFormatting.RED, false).setForceCustomHP(20).setSpecial();
        MobRarity.of(IRarity.BOSS, "Boss", 0, 1, 10, 3, ChatFormatting.RED, false).setForceCustomHP(20).setSpecial();
