...
public class OnAttackedCondition extends EffectCondition {

    public OnAttackedCondition() {
        super(Arrays.asList());
    }

    @Override
    public boolean canActivate(SpellCtx ctx, MapHolder data) {
        return ctx.activation == EntityActivation.ENTITY_BASIC_ATTACKED;
    }
